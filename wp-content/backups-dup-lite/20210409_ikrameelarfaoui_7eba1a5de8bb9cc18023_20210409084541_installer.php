...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210409_ikrameelarfaoui_7eba1a5de8bb9cc18023_20210409084541_archive.zip';
	const ARCHIVE_SIZE		 = '38342102';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7eba1a5-09084541';
    const SECONDARY_PACKAGE_HASH = '1d07066-09084541';
	const VERSION			 = '1.4.0';
